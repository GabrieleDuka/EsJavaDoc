...
* This class contains static methods for converting a String to 
* the application/x-www-form-urlencoded MIME format. For more information 
* about HTML form encoding, consult the HTML specification.
* <p>
* When encoding a String, the following rules apply: 
* <p>
* <ul>
*   <li> The alphanumeric characters "a" through "z", "A" through "Z" 
...
* "The string ü@foo-bar" would get converted to "The+string+%C3%BC%40foo-bar" 
* because in UTF-8 the character ü is encoded as two bytes C3 (hex) and 
...
public class URLEncoder {
   ...
   * This method uses the platform's default encoding as the encoding 
